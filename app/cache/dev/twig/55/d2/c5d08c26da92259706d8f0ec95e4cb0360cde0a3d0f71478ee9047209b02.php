...
/* knp_menu.html.twig */
class __TwigTemplate_55d2c5d08c26da92259706d8f0ec95e4cb0360cde0a3d0f71478ee9047209b02 extends Twig_Template
{
...
";
    ...
    public function block_children($context, array $blocks = array())
    {
        ...
        if ( !(null === $this->getAttribute($this->getContext($context, "options"), "depth", array()))) {
            // line 37
            $context["options"] = twig_array_merge($this->getContext($context, "options"), array("depth" => ($this->getAttribute($this->getContext($context, "currentOptions"), "depth", array()) - 1)));
        }
        // line 40
        if (( !(null === $this->getAttribute($this->getContext($context, "options"), "matchingDepth", array())) && ($this->getAttribute($this->getContext($context, "options"), "matchingDepth", array()) > 0))) {
            // line 41
            $context["options"] = twig_array_merge($this->getContext($context, "options"), array("matchingDepth" => ($this->getAttribute($this->getContext($context, "currentOptions"), "matchingDepth", array()) - 1)));
        }
        // line 43
...
$this->getContext($context, "matcher"), "isAncestor", array(0 => $this->getContext($context, "item"), 1 => $this->getAttribute($this->getContext($context, "options"), "matchingDepth", array())), "method")) {
                // line 58
    ...
    ";
            // line 68
            echo "    ";
            if (($this->getAttribute($this->getContext($context, "item"), "hasChildren", array()) &&  !($this->getAttribute($this->getContext($context, "options"), "depth", array()) === 0))) {
                // line 69
                echo "        ";
                if (( !twig_test_empty($this->getAttribute($this->getContext($context, "options"), "branch_class", array())) && $this->getAttribute($this->getContext($context, "item"), "displayChildren", array()))) {
                    // line 70
                    $context["classes"] = twig_array_merge($this->getContext($context, "classes"), array(0 => $this->getAttribute($this->getContext($context, "options"), "branch_class", array())));
                    // line 71
                    echo "        ";
                }
                // line 72
                echo "    ";
            } elseif ( !twig_test_empty($this->getAttribute($this->getContext($context, "options"), "leaf_class", array()))) {
                // line 73
                $context["classes"] = twig_array_merge($this->getContext($context, "classes"), array(0 => $this->getAttribute($this->getContext($context, "options"), "leaf_class", array())));
            }
            // line 76
            ...
            echo ">";
            // line 83
            if (( !twig_test_empty($this->getAttribute($this->getContext($context, "item"), "uri", array())) && ( !$this->getAttribute($this->getContext($context, "matcher"), "isCurrent", array(0 => $this->getContext($context, "item")), "method") || $this->getAttribute($this->getContext($context, "options"), "currentAsLink", array())))) {
                // line 84
                echo "        ";
...
";
    ...
    public function block_linkElement($context, array $blocks = array())
    {
        ...
        echo "\"";
        echo $context["knp_menu"]->getattributes($this->getAttribute($this->getContext($context, "item"), "linkAttributes", array()));
        echo ">";
    ...
    public function block_spanElement($context, array $blocks = array())
    {
        $context["knp_menu"] = $this;
        echo "<span";
        echo $context["knp_menu"]->getattributes($this->getAttribute($this->getContext($context, "item"), "labelAttributes", array()));
        echo ">";
        $this->displayBlock("label", $context, $blocks);
        echo "</span>";
    }
    ...
    public function block_label($context, array $blocks = array())
    {
        if (($this->getAttribute($this->getContext($context, "options"), "allow_safe_labels", array()) && $this->getAttribute($this->getContext($context, "item"), "getExtra", array(0 => "safe_label", 1 => false), "method"))) {
            echo $this->getAttribute($this->getContext($context, "item"), "label", array());
        } else {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "item"), "label", array()), "html", null, true);
        }
    }
