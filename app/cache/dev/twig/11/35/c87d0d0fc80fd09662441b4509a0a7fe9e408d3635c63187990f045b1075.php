...
class __TwigTemplate_1135c87d0d0fc80fd09662441b4509a0a7fe9e408d3635c63187990f045b1075 extends Twig_Template
{
    ...
    public function block_form($context, array $blocks = array())
    {
        // line 2
        echo "    ";
        echo call_user_func_array($this->env->getFunction('sonata_block_render_event')->getCallable(), array("sonata.admin.edit.form.top", array("admin" => $this->getContext($context, "admin"), "object" => $this->getContext($context, "object"))));
        echo "
    ...
    ";
            ...
            echo "        <form
              ";
            // line 12
            if (($this->getAttribute($this->getContext($context, "admin_pool"), "getOption", array(0 => "form_type"), "method") == "horizontal")) {
    ...
    ";
        // line 112
        echo call_user_func_array($this->env->getFunction('sonata_block_render_event')->getCallable(), array("sonata.admin.edit.form.bottom", array("admin" => $this->getContext($context, "admin"), "object" => $this->getContext($context, "object"))));
        echo "
...
";
    ...
    public function block_sonata_tab_content($context, array $blocks = array())
    {
        // line 29
        echo "                ";
        $context["has_tab"] = (((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "formtabs", array())) == 1) && ($this->getAttribute(twig_get_array_keys_filter($this->getAttribute($this->getContext($context, "admin"), "formtabs", array())), 0, array(), "array") != "default")) || (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "formtabs", array())) > 1));
        // line 30
        echo "
                <div class=\"col-md-12\">
                    ";
        // line 32
        if ($this->getContext($context, "has_tab")) {
            // line 33
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "admin"), "formtabs", array()));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["name"] => $context["form_tab"]) {
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "trans", array(0 => $context["name"], 1 => array(), 2 => $this->getAttribute($context["form_tab"], "translation_domain", array())), "method"), "html", null, true);
                echo "</a></li>
                                ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
            ...
            foreach ($context['_seq'] as $context["code"] => $context["form_tab"]) {
                ...
                echo "
                                                ";
                // line 48
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "form_helper"), "render_groups", array(0 => $this->getContext($context, "admin"), 1 => $this->getContext($context, "form"), 2 => $this->getAttribute($context["form_tab"], "groups", array(), "array"), 3 => $this->getContext($context, "has_tab")), "method"), "html", null, true);
                echo "
                                            </div>
                                        </div>
                                    </div>
            ...
            // line 56
            echo "                        ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "form_helper"), "render_groups", array(0 => $this->getContext($context, "admin"), 1 => $this->getContext($context, "form"), 2 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "admin"), "formtabs", array()), "default", array(), "array"), "groups", array()), 3 => $this->getContext($context, "has_tab")), "method"), "html", null, true);
            echo "
                    ";
        }
        // line 58
    ...
    public function block_formactions($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "isxmlhttprequest", array())) {
            ...
            // line 76
            echo "                        ";
            if ($this->getAttribute($this->getContext($context, "admin"), "supportsPreviewMode", array())) {
                // line 77
