...
class __TwigTemplate_882b684b7606f07d235c5ef104c4f6bef975ba60dd7fde337d7d58faf439d58d extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "getTotalBlock", array(), "method"), "html", null, true);
        echo "</span> blocks
                ";
        // line 9
        if ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "events", array())) > 0)) {
            echo "<strong>*</strong>";
        }
        // line 10
        echo "            </a>
        ...
        <div class=\"sf-toolbar-info\">
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
        // line 15
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "realBlocks", array())), "html", null, true);
        echo "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Containers</b>
                <span>";
        // line 19
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "containers", array())), "html", null, true);
        echo "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Total Blocks</b>
        ...
        echo "</span>
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
        // line 28
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "events", array())), "html", null, true);
        echo "</span>
            </div>
        </div>
    </div>
...
";
    ...
    <table>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "events", array()));
    ...
    ";
        // line 77
        $context["blocks"] = $this->getAttribute($this->getContext($context, "collector"), "realBlocks", array());
        // line 78
        echo "    ";
    ...
    ";
        // line 81
        $context["blocks"] = $this->getAttribute($this->getContext($context, "collector"), "containers", array());
        // line 82
        echo "    ";
        $this->displayBlock("table", $context, $blocks);
        echo "
    ...
    public function block_table($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["id"] => $context["block"]) {
            ...
            if ($this->getAttribute($this->getAttribute($context["block"], "cache", array()), "handler", array())) {
                // line 101
                echo "                ";
                $context["rowspan"] = ($this->getContext($context, "rowspan") + 1);
                // line 102
                echo "            ";
            }
            // line 103
            ...
            // line 108
            echo twig_escape_filter($this->env, $this->getContext($context, "rowspan"), "html", null, true);
            echo "\">";
