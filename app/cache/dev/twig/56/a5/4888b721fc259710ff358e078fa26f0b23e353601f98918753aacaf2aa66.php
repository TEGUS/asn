...
class __TwigTemplate_56a54888b721fc259710ff358e078fa26f0b23e353601f98918753aacaf2aa66 extends Twig_Template
{
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        if ( !(null === $this->getAttribute($this->getContext($context, "admin"), "id", array(0 => $this->getContext($context, "object")), "method"))) {
            // line 16
            echo "        ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title_edit", array("%name%" => twig_truncate_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "toString", array(0 => $this->getContext($context, "object")), "method"), 15)), "SonataAdminBundle"), "html", null, true);
            echo "
    ";
        } else {
            // line 18
