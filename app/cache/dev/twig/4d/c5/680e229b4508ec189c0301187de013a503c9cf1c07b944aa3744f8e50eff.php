...
class __TwigTemplate_4dc5680e229b4508ec189c0301187de013a503c9cf1c07b944aa3744f8e50eff extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        <span id=\"field_widget_";
            ...
            ";
            // line 14
            if (($this->getAttribute($this->getContext($context, "sonata_admin"), "edit", array()) == "inline")) {
                // line 15
                echo "                ";
                if (($this->getAttribute($this->getContext($context, "sonata_admin"), "inline", array()) == "table")) {
                    // line 16
                    echo "                    ";
                    if ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "form"), "children", array())) > 0)) {
                        // line 17
                        ...
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "children", array()), 0, array(), "array"), "children", array()));
                        ...
                        foreach ($context['_seq'] as $context["nested_group_field_name"] => $context["nested_group_field"]) {
                            ...
                            foreach ($context['_seq'] as $context["field_name"] => $context["nested_field"]) {
                                ...
                                echo "\">
                                                ";
                                // line 36
                                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "sonata_admin", true), "field_description", array(), "any", false, true), "associationadmin", array(), "any", false, true), "hasformfielddescriptions", array(0 => $context["field_name"]), "method", true, true)) {
                                    // line 37
                                    echo "                                                    ";
                    ...
                    // line 55
                    echo "                ";
                } elseif ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "form"), "children", array())) > 0)) {
                    // line 56
                    echo "                    <div>
                        ";
                    // line 57
