...
class __TwigTemplate_2b9899504d627ffcfab341996fe02ab6b37c044258a15cb479cb0c6f4f09ef5e extends Twig_Template
{
    ...
    public function block_user_block($context, array $blocks = array())
    {
        // line 2
        echo "    ";
        $context["items_per_column"] = $this->getAttribute($this->getContext($context, "admin_pool"), "getOption", array(0 => "dropdown_number_groups_per_colums"), "method");
        // line 3
        echo "    ";
    ...
    ";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                if (($this->getContext($context, "display_group") == false)) {
                    // line 9
                    echo "            ";
                    if (($this->getAttribute($context["admin"], "hasRoute", array(0 => "create"), "method") && $this->getAttribute($context["admin"], "isGranted", array(0 => "CREATE"), "method"))) {
                        ...
                        // line 11
                        echo "                ";
                        $context["groups"] = twig_array_merge(array(0 => $context["group"]), $this->getContext($context, "groups"));
                        // line 12
                        echo "            ";
                    }
                    // line 13
    ...
    ";
        // line 16
        $context["column_count"] = twig_round((twig_length_filter($this->env, $this->getContext($context, "groups")) / $this->getContext($context, "items_per_column")), 0, "ceil");
        // line 17
        echo "
    <div class=\"dropdown-menu multi-column dropdown-add\"
        ";
        // line 19
        if (($this->getContext($context, "column_count") > 1)) {
            echo "style=\"width: ";
            echo twig_escape_filter($this->env, ($this->getContext($context, "column_count") * 140), "html", null, true);
            echo "px;\"";
        }
        // line 20
        echo "            >
        ...
        // line 21
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, $this->getContext($context, "groups")));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            if ($this->getContext($context, "display")) {
                ...
                ";
                // line 29
                if (($this->getAttribute($context["loop"], "first", array()) || (($this->getAttribute($context["loop"], "index0", array()) % $this->getContext($context, "items_per_column")) == 0))) {
                    // line 30
                    echo "                    ";
                    ...
                    if (($this->getContext($context, "column_count") > 1)) {
                        echo " col-md-";
                        echo twig_escape_filter($this->env, twig_round((12 / $this->getContext($context, "column_count"))), "html", null, true);
                    }
                    echo "\">
                ";
                }
                ...
                ";
                // line 40
                if ((($this->getAttribute($context["loop"], "index0", array()) % $this->getContext($context, "items_per_column")) != 0)) {
                    // line 41
