...
class __TwigTemplate_d54ac06dafd333c3c267dba8a200e995ec2133b972e6da2cb11ff0215678c1f9 extends Twig_Template
{
...
";
    ...
    public function block_javascripts($context, array $blocks = array())
    {
        ...
        if ((array_key_exists("admin_pool", $context) && $this->getAttribute($this->getContext($context, "admin_pool"), "getOption", array(0 => "use_select2"), "method"))) {
            // line 56
            echo "                ";
            $context["locale"] = $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "locale", array());
            // line 57
            echo "                ";
            if (($this->getContext($context, "locale") == "pt")) {
            ...
            // line 60
            echo "                ";
            if ((twig_slice($this->env, $this->getContext($context, "locale"), 0, 2) != "en")) {
                // line 61
                echo "                    <script src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl((("bundles/sonataadmin/vendor/select2/select2_locale_" . strtr($this->getContext($context, "locale"), array("_" => "-"))) . ".js")), "html", null, true);
                echo "\"></script>
                ";
            }
            // line 63
    ...
    public function block_logo($context, array $blocks = array())
    {
        ...
        if ((("single_image" == $this->getAttribute($this->getContext($context, "admin_pool"), "getOption", array(0 => "title_mode"), "method")) || ("both" == $this->getAttribute($this->getContext($context, "admin_pool"), "getOption", array(0 => "title_mode"), "method")))) {
            // line 104
            echo "                            <img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getContext($context, "admin_pool"), "titlelogo", array())), "html", null, true);
            echo "\" alt=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "admin_pool"), "title", array()), "html", null, true);
            echo "\">
                        ";
        }
        // line 106
        ...
        echo "                                <div class=\"navbar-right\">
                                    <ul class=\"nav navbar-nav\">
                                        <li class=\"dropdown\">
                                            ...
                                            ";
        // line 157
        $this->env->resolveTemplate($this->getAttribute($this->getContext($context, "admin_pool"), "getTemplate", array(0 => "add_block"), "method"))->display($context);
        // line 158
        echo "                                        </li>
                                        <li class=\"dropdown user-menu\">
                                            ...
                                            <ul class=\"dropdown-menu dropdown-user\">
                                                ";
        // line 164
        $this->env->resolveTemplate($this->getAttribute($this->getContext($context, "admin_pool"), "getTemplate", array(0 => "user_block"), "method"))->display($context);
        // line 165
        echo "                                            </ul>
                                        </li>
                                    </ul>
    ...
    public function block_sonata_sidebar_search($context, array $blocks = array())
    {
        // line 183
        echo "                                    ";
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "security", array()), "token", array()) && $this->env->getExtension('security')->isGranted("ROLE_SONATA_ADMIN"))) {
            // line 184
            echo "                                        <form action=\"";
            ...
            // line 186
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "get", array(0 => "q"), "method"), "html", null, true);
    ...
    public function block_side_bar_nav($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "security", array()), "token", array()) && $this->env->getExtension('security')->isGranted("ROLE_SONATA_ADMIN"))) {
            ...
            // line 201
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "admin_pool"), "dashboardgroups", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                ...
                if (($this->getContext($context, "display") && ($this->getContext($context, "item_count") > 0))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                        // line 220
                        echo "                                                        ";
                        if ((($this->getAttribute($context["admin"], "hasroute", array(0 => "list"), "method") && $this->getAttribute($context["admin"], "isGranted", array(0 => "LIST"), "method")) && ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "get", array(0 => "_sonata_admin"), "method") == $this->getAttribute($context["admin"], "code", array())))) {
                            // line 221
                            echo "                                                            ";
                            $context["active"] = true;
                            // line 222
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                        ...
                        if (($this->getAttribute($context["admin"], "hasroute", array(0 => "list"), "method") && $this->getAttribute($context["admin"], "isGranted", array(0 => "LIST"), "method"))) {
                            // line 233
                            echo "                                                                    <li";
                            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request", array()), "get", array(0 => "_sonata_admin"), "method") == $this->getAttribute($context["admin"], "code", array()))) {
                                echo " class=\"active\"";
                            }
                            echo "><a href=\"";
    ...
    public function block_sonata_page_content_nav($context, array $blocks = array())
    {
        ...
        if (( !twig_test_empty($this->getContext($context, "_tab_menu")) ||  !twig_test_empty($this->getContext($context, "_actions")))) {
            ...
            echo "                                                </div>
                                                ...
                                                ";
            // line 272
            if ( !twig_test_empty(trim(strtr($this->getContext($context, "_actions"), array("<li>" => "", "</li>" => ""))))) {
                // line 273
