...
class __TwigTemplate_923531d3f79b5f5dc720f593eec7a4a4fb0cf047f33416571dab15799a1f221c extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("ASNMainBundle::layout.html.twig", "ASNCalendarBundle::layout.html.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 4
        echo "    <div class=\"row\" data-ng-controller=\"AgendaController\">
...
";
    ...
    {
        // line 182
        echo "                <div class=\"col-lg-12 col-md-12 col-sm-12\" id=\"aside\">
                    ...
                    <div class=\"panel panel-primary\" data-ng-show=\"active && evenements.length !== 0\">
                        <div class=\"panel-heading\">
                            Evènements
                        </div>
                        <div>
                    ...
                    <div class=\"panel panel-primary\" data-ng-show=\"active && taches.length !== 0\">
                        <div class=\"panel-heading\">
                            Tâches
                        </div>
                        <div>
...
";
    ...
    {
        return array (  364 => 299,  323 => 262,  320 => 261,  314 => 255,  239 => 182,  236 => 181,  182 => 128,  112 => 61,  56 => 7,  53 => 6,  47 => 257,  45 => 181,  40 => 178,  38 => 6,  34 => 4,  31 => 3,  11 => 1,);
    }
}
/* {% extends "ASNMainBundle::layout.html.twig" %}*/
/* */
/* {% block section %}*/
/*     <div class="row" data-ng-controller="AgendaController">*/
/*         <div class="col-lg-8" id="actualites">*/
/*             {% block actualites %}*/
/*                 <div class="row">*/
/*                     <div class="col-lg-4">*/
...
/*         <div class="col-lg-4" id="aside">*/
/*             {% block aside %}*/
/*                 <div class="col-lg-12 col-md-12 col-sm-12" id="aside">*/
/*                     <div class="panel panel-primary">*/
/*                         <div class="panel-heading">*/
/*                             <button type="submit" class="btn btn-primary btn-block" data-toggle="modal" data-target=".bs-agenda-modal-sm">*/
/*                                 Nouvel agenda*/
